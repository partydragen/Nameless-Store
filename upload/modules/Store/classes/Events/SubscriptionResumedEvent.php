<?php
class SubscriptionResumedEvent extends AbstractEvent implements HasWebhookParams, DiscordDispatchable {
    ...
    public static function description(): string {
        return 'Store » ' . (new Language(ROOT_PATH . '/modules/Store/language'))->get('admin', 'subscription_resumed');
    }
    ...
    public function toDiscordWebhook(): DiscordWebhookBuilder {
        ...
        return DiscordWebhookBuilder::make()
            ...
            ->addEmbed(function (DiscordEmbed $embed) use ($store_language, $customer) {
                return $embed
                    ->setDescription($store_language->get('general', 'subscription_resumed', [
                        'username' => $customer->getUsername(),
